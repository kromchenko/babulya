    ...
    static public function show_license_form() {
        ...
        <div class="dce-notice <?php echo $classes; ?>">
            ...
            <form action="" method="post">
                <?php _e('Your key', DCE_TEXTDOMAIN ); ?>: <input type="text" name="licence_key" value="<?php echo $licence_key_hidden; ?>" id="licence_key" placeholder="dce-xxxxxxxx-xxxxxxxx-xxxxxxxx" style="width: 240px; max-width: 100%;">
