...
class DCE_Widget_ReadMore extends DCE_Widget_Prototype {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'readmore_color', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dce-btn-readmore > span, {{WRAPPER}} .dce-btn-readmore .icon-rm' => 'color: {{VALUE}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                        '{{WRAPPER}} .icon-rm' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                        '{{WRAPPER}} .icon-rm' => 'top: {{SIZE}}{{UNIT}} !important;',
                ],
        ...
        $this->add_control(
            'readmore_color_hover', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .dce-btn-readmore:hover > span, {{WRAPPER}} .dce-btn-readmore:hover:after,  {{WRAPPER}} .dce-btn-readmore:hover:before, {{WRAPPER}} .dce-btn-readmore .icon-rm' => 'color: {{VALUE}};',
                ],
    ...
    protected function render() {
        ...
        if ($link) {
            ...
            $html .= sprintf('<%1$s class="dce-btn-readmore%2$s%3$s%4$s">%5$s</%s>', $settings['html_tag'], $animation_class, $effect_class, $icon_class, $title);
        }
