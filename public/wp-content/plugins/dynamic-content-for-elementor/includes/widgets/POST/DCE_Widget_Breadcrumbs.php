       ...
       if( !function_exists('yoast_breadcrumb') || !$this->is_yoast_breadcrumbs()){
        ...
        $this->add_control(
            'color', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dce-breadcrumbs li, {{WRAPPER}} .dce-breadcrumbs a, {{WRAPPER}} .dce-breadcrumbs span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
          'final_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .dce-breadcrumbs .breadcrumb_last' => 'color: {{VALUE}};',
            ],
          ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector' => '{{WRAPPER}} .dce-breadcrumbs .breadcrumb_last',
            ]
        );
        ...
        $this->add_control(
            'separator_color', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dce-breadcrumbs .separator' => 'color: {{VALUE}};',
                ],
