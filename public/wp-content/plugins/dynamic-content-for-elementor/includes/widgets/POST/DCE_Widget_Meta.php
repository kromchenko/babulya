...
class DCE_Widget_Meta extends DCE_Widget_Prototype {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::SWITCHER,
            'description' => __("If you want to show something when field is empty.", DCE_TEXTDOMAIN),
                ]
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        // ------------------------------------------
        //
        /*$post_id = get_post_meta(get_the_ID(), 'demo_id', true);
        if (!$post_id) {
            $post_id = get_the_ID();
        }*/
        //$post_id
        //$demo_page = get_post($post_id);
        //$page_type = get_post_type($demo_page);


        // TYPES
        $acf_types = array("text", "textarea", "number", "range", "email", "url", "password", "image", "file", "wysiwyg", "oembed", "gallery", "select", "checkbox", "radio", "button_group", "true_false", "link", "post_object", "page_link", "relationship", "taxonomy", "user", "google_map", "date_picker", "date_time_picker", "time_picker", "color_picker", "message", "accordion", "tab", "group", "repeater", "flexible_content", "clone");
        $pods_types = array("text", "website", "phone", "email", "password", "paragraph", "wysiwyg", "code", "datetime", "date", "time", "number", "currency", "file", "oembed", "pick", "boolean", "color");
        $toolset_types = array("audio", "colorpicker", "email", "embed", "file", "image", "numeric", "phone", "textarea", "textfield", "url", "video", "checkboxes", "checkbox", "date", "radio", "select", "skype", "wysiwyg", "multiple");
        ...
        $original_type = $this->_get_meta_type($meta_name, $meta_value);
        ...
        switch ($render_type) {
            ...
            case 'id':
                ...
                if ($settings['dce_meta_id_render_type'] == 'template') {
                    $meta_html = do_shortcode('[dce-elementor-template id="' . $settings['dce_meta_id_render_type_template'] . '"]');
                }
                break;
    ...
    public function _get_meta_type($meta_name, $meta_value) {
