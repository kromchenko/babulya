    ...
    */
    ...
    protected function render() {
        ...
        if ( $typeField == 'image' || $typeField == 'image_url' ){
            $imageField = get_field( $idFields , $id_page);
        ...
        if( $typeField == 'text' || 
            ...
            // se sono un TESTO .................
            $acfResult = get_field( $idFields , $id_page); //$settings['acf_field_list']; //get_the_title($id_page); ... $idFields+' '+$id_page+' - '+
            ...
            */
            ...
            $videoField = get_field( $idFields , $id_page, false);
                    ...
                    if ( ! $settings['lightbox'] ) {
                        if( $settings['image_overlay_type'] == 'custom' ){
                            ...
                            if( is_string($immagine_acf_overlay) ){
                                ...
                                $immagine_acf_overlay = 'image_array';
        ...
        //echo '<p>bbb ' . get_field( 'test_testo' , $id_page) . '</p>';
