...
function wsppc_edit_form()
{
	...
	<form method="post" class="wsppc_form">
			...
			<tbody>
					...
					<th scope="row">
						...
						<span>
							<select id="" name="hook">
								...
								<option value="<?php echo $hooks ?>"><?php echo  $i.". ".str_replace("_"," ",$hooks); ?></option>
								<?php $i++;} ?>
							</select>
				...
				<tr valign="top">				
					<td>
					<textarea name="content" rows="12" class="wsppc_content"> <?php  echo wp_unslash($hook_value); ?></textarea>
