                        ...
                        if ( $content['type'] === 'url' ) {
                            ...
                            if ( $content['type'] === 'changelog' ) {
                                ...
                                if ( $content['type'] === 'frame' ) {
                                    $height = ( !empty($content['height']) ? $content['height'] : 1600 );
                                    echo  '<iframe src="' . esc_url( $content['frame'] ) . '" frameborder="no" style="min-height:' . intval( $height ) . 'px;width:100%"></iframe>' ;
                                }
